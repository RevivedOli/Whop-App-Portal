...
/**
 * POST /api/knowledge/courses/lessons/[lessonId]/keep-orphaned
 * 
...
export async function POST(
	...
	console.log('[api/knowledge/courses/lessons/[lessonId]/keep-orphaned] Request received')
	...
	try {
		...
		if (!tokenData) {
			console.error('[api/knowledge/courses/lessons/[lessonId]/keep-orphaned] Authentication failed')
		...
		if (fetchError) {
			console.error('[api/knowledge/courses/lessons/[lessonId]/keep-orphaned] Error fetching lesson:', fetchError)
			return Response.json(
		...
		if (error) {
			console.error('[api/knowledge/courses/lessons/[lessonId]/keep-orphaned] Database error:', error)
			return Response.json(
		...
		console.error('[api/knowledge/courses/lessons/[lessonId]/keep-orphaned] Error:', error)
		return Response.json(
