...
/**
 * POST /api/admin/knowledge/courses/lessons/[lessonId]/generate-summary
 * 
...
export async function POST(
	...
	console.log('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Request received');

	try {
		const { lessonId } = await params;
		const requestHeaders = await headers();
		
		console.log('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Lesson ID:', lessonId);
		...
		if (!tokenData) {
			console.error('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Authentication failed');
			return Response.json(
				{ error: 'Unauthorized' },
				{ status: 401 },
			);
		...
		console.log('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Calling edge function');
		...
		if (!edgeFunctionResponse.ok) {
			...
			console.error('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Edge function error:', errorData);
			return Response.json(
				{ 
		...
		console.error('[admin/knowledge/courses/lessons/[lessonId]/generate-summary] Error:', error);
